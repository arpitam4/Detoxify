...
app.get('/login', (req, res) => {
  ...
  const authorizationUrl = "https://accounts.spotify.com/en/authorize?client_id=${client_id}&response_type=code&redirect_uri=${encodeURIComponent(redirect_uri)}&state=${state}&show_dialog=false&scope=${encodeURIComponent(scopes)}";
